...
def test_get_mex_column_rename_map_types_and_length():
    """Simple test of the get_mex_column_rename_map function"""
    rename_map = get_mex_column_rename_map()
