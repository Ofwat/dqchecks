...
def get_ccp_column_rename_map() -> dict[str, str]:
    ...
    return {
        ...
        "WTW_Cd": "WTW_Cd",
        "Growth_Subcategory_Cd": "Growth_Subcategory_Cd",
        "WWTW_Cd": "WWTW_Cd",
        "WWTW_Scheme_Cd": "WWTW_Scheme_Cd",
        "WRZ_Cd": "WRZ_Cd",
        "WRMP_Planning_Scenario_Cd": "WRMP_Planning_Scenario_Cd",
        "WRMP_Scheme_Cd": "WRMP_Scheme_Cd",
        "WRMP_Scheme_Status_Cd": "WRMP_Scheme_Status_Cd",
        "WRMP_Scheme_Classification_Cd": "WRMP_Scheme_Classification_Cd",
        "WRMP_Scheme_Option_Cd": "WRMP_Scheme_Option_Cd",
        "STC_Cd": "STC_Cd",
        "Network_Reinforcement_Scheme_Cd": "Network_Reinforcement_Scheme_Cd",
        "Gated_Scheme_Item_Cd": "Gated_Scheme_Item_Cd",
        "WINEP_NR_Scheme_Cd": "WINEP_NR_Scheme_Cd",
        "WINEP_SO_Scheme_Cd": "WINEP_SO_Scheme_Cd",
        "Price_Base_Cd": "Price_Base_Cd",
